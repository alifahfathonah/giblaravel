                                ...
                                <tbody>
                                    ...
                                    @foreach ($datas as $data)
                                        <tr>
                                            ...
                                            <td>{{ $data->name }}</td>
                                            <td class="text-right">
                                                <a href="{{ route('masters.jobs.restore', $data->id) }}" class="btn btn-sm btn-success"><i class="ft-repeat"></i> <span class="d-none d-xl-inline">Restore</span></a>
                                                
                                                <form action="{{ route('masters.jobs.force-delete', $data->id) }}" class="d-inline" method="POST">
                                                    @csrf @method('DELETE')
