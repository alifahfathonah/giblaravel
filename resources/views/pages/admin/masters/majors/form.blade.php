@php
    ...
    $route = $isEdit ? route('masters.majors.update', $data->id) : route('masters.majors.store');
@endphp
...
@if ($isEdit)
  ...
  @section('title', 'Master - Jurusan ~Edit')    

@else

  @section('title', 'Master - Jurusan ~Tambah')    
                            ...
                            <form class="form" action="{{ $route }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="nameInput" class="form-control round" placeholder="nama jurusan" name="name" value="{{ $isEdit ? $data->name : '' }}" required>
                                    </div>
