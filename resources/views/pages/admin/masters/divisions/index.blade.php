                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                ...
                                <a href="{{ route('masters.divisions.create') }}" class="btn btn-md btn-primary">
                                    <i class="ft-plus" style="font-size: 1.3em;"></i> <span class="d-none d-lg-inline">Tambah Data</span>
                                </a>
                                
                                <a href="{{ route('masters.divisions.show', 'trashed') }}" class="btn btn-md btn-info">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($datas as $data)
                                        <tr>
                                            ...
                                            <td>{{ $data->name }}</td>
                                            <td class="text-right">
                                                <a href="{{ route('masters.divisions.edit', $data->id) }}" class="btn btn-sm btn-warning"><i class="ft-edit"></i> <span class="d-none d-xl-inline">Edit</span></a>
                                                
                                                <form action="{{ route('masters.divisions.destroy', $data->id) }}" class="d-inline" method="POST">
                                                    @csrf @method('DELETE')
